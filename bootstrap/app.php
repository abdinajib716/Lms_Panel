...
return Application::configure(basePath: dirname(__DIR__))
    ->withRouting(
        ...
        using: function () {
            ...
            Route::middleware(['web', 'installed', 'appConfig'])->group(function () {
                ...
                // Admin routes
                Route::middleware(['auth', 'verified', 'role:admin'])->group(base_path('routes/admin.php'));

                // Instructor routes
                Route::middleware(['auth', 'verified', 'role:admin,instructor'])->group(base_path('routes/instructor.php'));

                // Student routes
                Route::middleware(['auth', 'verified', 'role:student,instructor,admin'])->group(base_path('routes/student.php'));
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->alias([
            ...
            'apiVerified' => \App\Http\Middleware\EnsureApiEmailIsVerified::class,
