...
class UpdateCourseRequest extends FormRequest
{
    ...
    private function pricingTabRules(): array
    {
        ...
        return [
            ...
            'price' => "nullable|numeric|min:0.01|required_if:pricing_type,$paid",
            'discount' => 'boolean',
            'discount_price' => [
                'nullable',
                'numeric',
                ...
                function ($attribute, $value, $fail) {
                    if ($this->input('discount') && $value !== null && $this->input('price') !== null) {
                        if ((float) $value >= (float) $this->input('price')) {
