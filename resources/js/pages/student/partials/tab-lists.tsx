...
import { CreditCard, LayoutDashboard, LogOut, LucideProps } from 'lucide-react';
   ...
   return (
      <div>
         ...
         <TabsList className="grid h-auto grid-cols-1 gap-2 bg-transparent p-0">
            ...
            <Button
               variant="ghost"
               className="text-muted-foreground h-10 w-full justify-start gap-3 rounded-md px-4"
               onClick={() => router.get(route('student.transactions'))}
            >
